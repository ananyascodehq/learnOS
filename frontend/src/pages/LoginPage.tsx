...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-dark relative overflow-hidden">
            ...
            <div className="absolute top-[30%] right-[20%] w-[300px] h-[300px] rounded-full bg-projects/10 blur-[100px]" />
            ...
            <div className="relative z-10 w-full max-w-md mx-4">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-10 shadow-2xl">
                    ...
                    <div className="flex items-center justify-center gap-3 mb-3">
                        ...
                        <h1 className="text-3xl font-bold text-white tracking-tight">LearnOS</h1>
                    </div>

                    {/* Tagline */}
                    <p className="text-center text-muted text-sm mb-10">
                        Your personal study intelligence platform
                    </p>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-dark font-medium py-3.5 px-6 rounded-xl transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                    ...
                    <p className="text-center text-muted/60 text-xs mt-8">
                        Log your learning sessions, track progress, and get AI-powered insights.
                    </p>
                </div>
